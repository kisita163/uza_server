...
public class Amazon implements IRunnableWithProgress{
	...
	public Amazon(boolean indeterminate, String searchIndex, String keyWords, String volume, String weight) {
	...
	public void run(IProgressMonitor monitor) throws InvocationTargetException,
    	...
    	if(xml != null){
    	    try {
    			AmazonXmlParser parser = new AmazonXmlParser(xml,volumeMax,weightMax);
    			...
    			if(parser.getTotalPages() > 1){
    				for(int k = 2 ; k <= 10 ; k++){
    					...
    					AmazonXmlParser parser_k = new AmazonXmlParser(xml_k,volumeMax,weightMax);
